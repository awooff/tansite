defmodule MixcrackWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(MixcrackWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(MixcrackWeb.Gettext, "errors", msg, opts)
    end
  end
